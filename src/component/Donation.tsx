      ...
      {/* <div className="mb-12">
        <div className="bg-[#171b26] w-full rounded-lg p-6 md:p-8">
          ...
          <div className="w-full px-11 pt-2 space-y-5">
            <p>
              🗃️ ⚡ Thank you for your generous support! Your contribution is
              making a real difference and brings us closer to our goal. We
              deeply appreciate your kindness and commitment!
            </p>

            <div className="">
              <p className="text-3xl text-green-800">${amount.slice(0, -2)}</p>
            </div>
